...
class TambahSkillScreen extends StatefulWidget {
  const TambahSkillScreen({Key? key}) : super(key: key);
...
class _TambahSkillScreenState extends State<TambahSkillScreen> {
  ...
  final TextEditingController _targetWaktuController = TextEditingController(text: '15');
  ...
  final List<Map<String, dynamic>> _kategoriList = [
    {'nama': 'Musik', 'icon': 'assets/images/alatmusik.png', 'color': Color(0xFFE57373)},
    {'nama': 'Teknologi / Digital', 'icon': 'assets/images/laptop.png', 'color': Color(0xFF64B5F6)},
    {'nama': 'Akademik', 'icon': 'assets/images/akademik.png', 'color': Color(0xFF4DB6AC)},
    {'nama': 'Bahasa', 'icon': 'assets/images/bahasa.png', 'color': Color(0xFFFFB74D)},
    {'nama': 'Olahraga', 'icon': 'assets/images/olahraga.png', 'color': Color(0xFF81C784)},
    {'nama': 'Seni / Kreativitas', 'icon': 'assets/images/lukis.png', 'color': Color(0xFFBA68C8)},
    {'nama': 'Lainnya', 'icon': 'assets/images/lainnya.png', 'color': Color(0xFF90A4AE)},
  ];
  ...
  void _tambahSkill() {
    ...
    final skillData = {
      ...
      'target': int.tryParse(_targetWaktuController.text) ?? 15,
      'unit': _selectedWaktuUnit ?? 'Menit',
      'kategori': _selectedKategori,
    };

    Navigator.pop(context, skillData);
  }
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    height: 44,
                                    decoration: BoxDecoration(
                                      color: kategori['color'].withOpacity(0.15),
                                      borderRadius: BorderRadius.circular(10),
                                    ),
                                    child: Center(
                                      child: Image.asset(
